...
<head>
    ...
    <title>Write Review - Happy Paws</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('customer.feedback.create') }}" class="bg-amber-700 text-white px-3 py-2 rounded-md text-sm font-medium">
    ...
    <div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 py-6 sm:px-0">
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-gray-600">Share your experience with our products and services</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <form method="POST" action="{{ route('customer.feedback.store') }}">
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Order Selection (if recent orders exist) -->
                            ...
                            <div class="flex items-center space-x-2">
                                @for($i = 1; $i <= 5; $i++)
                                    ...
                                    <label for="rating_{{ $i }}" class="cursor-pointer">
                                        <i class="fas fa-star text-2xl {{ old('rating') >= $i ? 'text-yellow-400' : 'text-gray-300' }} hover:text-yellow-400 transition-colors"></i>
                                    </label>
                                @endfor
                        ...
                        <div>
                            ...
                            <select name="feedback_type" id="feedback_type" required
                                ...
                                <option value="product" {{ old('feedback_type') == 'product' ? 'selected' : '' }}>Product Review</option>
                                <option value="service" {{ old('feedback_type') == 'service' ? 'selected' : '' }}>Customer Service</option>
                                <option value="delivery" {{ old('feedback_type') == 'delivery' ? 'selected' : '' }}>Delivery Experience</option>
                        ...
                        <div>
                            ...
                            <textarea name="feedback_text" id="feedback_text" rows="6" required
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-amber-500 focus:border-amber-500">{{ old('feedback_text') }}</textarea>
