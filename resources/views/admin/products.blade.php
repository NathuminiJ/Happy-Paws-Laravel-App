            ...
            <div class="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <h1 class="text-2xl font-bold text-amber-900">Products Management</h1>
                    </div>
            ...
            <div class="p-6">
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="{{ route('admin.products.create') }}" class="bg-amber-600 text-white px-4 py-2 rounded-lg hover:bg-amber-700 transition-colors duration-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($products as $product)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $product->stock ?? 'N/A' }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                ...
                                                <a href="{{ route('admin.products.edit', $product) }}" class="text-amber-600 hover:text-amber-900 mr-3">Edit</a>
