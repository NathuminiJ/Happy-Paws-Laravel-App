        ...
        <div class="flex-1 ml-64">
            ...
            <div class="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <h1 class="text-2xl font-bold text-amber-900">Order Details</h1>
                    </div>
            ...
            <div class="p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900">${{ number_format($order->subtotal, 2) }}</p>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Tax</label>
                                    <p class="mt-1 text-sm text-gray-900">${{ number_format($order->tax_amount, 2) }}</p>
                                </div>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Total Amount</label>
                                <p class="mt-1 text-lg font-semibold text-gray-900">${{ number_format($order->total_amount, 2) }}</p>
                            </div>
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                ...
                <div class="mt-6 flex justify-end space-x-4">
                    <a href="{{ route('admin.orders.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors duration-200">
                        <i class="fas fa-arrow-left mr-2"></i>Back to Orders
                    </a>
                    <a href="{{ route('admin.orders.edit', $order) }}" class="bg-amber-600 text-white px-4 py-2 rounded-lg hover:bg-amber-700 transition-colors duration-200">
